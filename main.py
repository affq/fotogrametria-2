...
def wyznaczanie_obserwacji_odstajacych(chmura_punktow, liczba_sasiadow = 20, std_ratio = 3.0):
...
if __name__ == "__main__":
    ...
    chmura_punktow_woksele = regularyzacja_chmur_punktow(chmura_punktow, odleglosc_miedzy_wokselami = 0.1)
